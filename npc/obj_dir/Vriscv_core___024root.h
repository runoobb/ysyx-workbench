...
class Vriscv_core___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ riscv_core__DOT__ready_exu_idu_w;
        CData/*0:0*/ riscv_core__DOT__u0_ifu__DOT____Vcellinp__u0_if_id__stall;
        ...
        CData/*0:0*/ __Vdly__riscv_core__DOT__valid_exu_lsu_w;
        ...
        CData/*0:0*/ riscv_core__DOT__valid_lsu_regfile_w;
        CData/*0:0*/ riscv_core__DOT__u0_ifu__DOT__pc_icache_handshake;
        CData/*0:0*/ riscv_core__DOT__u0_ifu__DOT__pc_icache_valid;
        CData/*0:0*/ riscv_core__DOT__u0_ifu__DOT__ifu_icache_ready;
        CData/*0:0*/ riscv_core__DOT__u0_idu__DOT__downstream_handshake;
        CData/*0:0*/ riscv_core__DOT__u0_lsu__DOT__downstream_handshake;
        ...
        CData/*0:0*/ riscv_core__DOT__valid_idu_exu_w;
        CData/*0:0*/ riscv_core__DOT__valid_exu_lsu_w;
    ...
    struct {
        ...
        CData/*0:0*/ riscv_core__DOT____Vcellinp__u0_riscv_regfile__rd_we_i;
        VL_IN8(rst,0,0);
        CData/*0:0*/ riscv_core__DOT__valid_ifu_idu_w;
